...
const Auth = () => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        if (data.error) {
          ...
          setErrorMessage(data.message); // Show success message
      ...
      if (error.code === 'ECONNABORTED') {
        ...
        setErrorMessage(serverMessage || error.message || "Connection failed. Please try again.");
      }
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <div className="min-h-screen bg-[#0b0e14] flex flex-col items-center justify-center p-6 text-slate-200">
      ...
      <div className="w-full max-w-md bg-[#111827]/50 border border-white/5 backdrop-blur-xl p-8 rounded-4xl shadow-2xl">
